...
$_mod.def("/digital-measures-faculty-info$0.0.1/pages/slash/index.marko.init", function(require, exports, module, __filename, __dirname) { window.$initComponents && window.$initComponents()
});
$_mod.run("/digital-measures-faculty-info$0.0.1/pages/slash/index.marko.init");